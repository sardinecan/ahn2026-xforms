...
Dans le champ des sciences humaines et sociales, où les formats XML sont largement adoptés (TEI, EAD, EAC-CPF en tête), XForms apporte une réponse concrète à un problème récurrent : comment produire des données XML sans recourir à une édition manuelle dans un éditeur de texte ?
...
### Liens utiles
- XForms 1.1 W3C Recommendation, &lt;https://www.w3.org/TR/xforms11/&gt;
- Dan McCreary, *XForms Tutorial and Cookbook Wikibook!*, &lt;https://en.wikibooks.org/wiki/XForms&gt;
- Alain Couthures, *declarative4all*, &lt;https://github.com/AlainCouthures/declarative4all&gt; (client XForms)